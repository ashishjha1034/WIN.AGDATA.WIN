...
function AdminSidebarComponent_img_3_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelement(0, "img", 16);
} }
function AdminSidebarComponent_li_8_span_4_Template(rf, ctx) { if (rf & 1) {
...
function AdminSidebarComponent_li_8_span_5_Template(rf, ctx) { if (rf & 1) {
...
function AdminSidebarComponent_li_8_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵelement(3, "i");
    i0.ɵɵelementEnd();
    i0.ɵɵtemplate(4, AdminSidebarComponent_li_8_span_4_Template, 2, 1, "span", 20)(5, AdminSidebarComponent_li_8_span_5_Template, 2, 1, "span", 21);
    i0.ɵɵelementEnd()();
} if (rf & 2) {
...
function AdminSidebarComponent_div_10_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵadvance(2);
    i0.ɵɵtextInterpolate((ctx_r1.currentUser.roles == null ? null : ctx_r1.currentUser.roles[0]) || "User");
} }
function AdminSidebarComponent_div_11_Template(rf, ctx) { if (rf & 1) {
...
function AdminSidebarComponent_span_15_Template(rf, ctx) { if (rf & 1) {
...
export class AdminSidebarComponent {
    ...
    static { this.ɵfac = function AdminSidebarComponent_Factory(__ngFactoryType__) { return new (__ngFactoryType__ || AdminSidebarComponent)(i0.ɵɵdirectiveInject(i1.AuthService), i0.ɵɵdirectiveInject(i2.Router)); }; }
    static { this.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: AdminSidebarComponent, selectors: [["app-admin-sidebar"]], decls: 16, vars: 7, consts: [[1, "sidebar"], [1, "sidebar-header"], [1, "logo-wrapper"], ["src", "assets/brand/agdata-logo-white.png", "alt", "AGDATA", "class", "agdata-logo", 4, "ngIf"], ["title", "Toggle sidebar", 1, "toggle-btn", 3, "click"], [1, "fa-solid", "fa-circle-dot"], [1, "sidebar-nav"], [1, "menu-list"], ["class", "menu-item", 4, "ngFor", "ngForOf"], [1, "sidebar-footer"], ["class", "user-info", 4, "ngIf"], ["class", "user-avatar-only", 4, "ngIf"], ["title", "Logout", 1, "logout-btn", 3, "click"], ["viewBox", "0 0 24 24", "fill", "currentColor"], ["d", "M17 7l-1.41 1.41L18.17 11H8v2h10.17l-2.58 2.58L17 17l5-5zM4 5h8V3H4c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h8v-2H4V5z"], [4, "ngIf"], ["src", "assets/brand/agdata-logo-white.png", "alt", "AGDATA", 1, "agdata-logo"], [1, "menu-item"], ["routerLinkActive", "active", 1, "menu-link", 3, "routerLink", "routerLinkActiveOptions", "title"], [1, "menu-icon"], ["class", "menu-label", 4, "ngIf"], ["class", "badge", 4, "ngIf"], [1, "menu-label"], [1, "badge"], [1, "user-info"], [1, "user-avatar"], [1, "user-details"], [1, "user-name"], [1, "user-role"], [1, "user-avatar-only"]], template: function AdminSidebarComponent_Template(rf, ctx) { if (rf & 1) {
            i0.ɵɵelementStart(0, "aside", 0)(1, "div", 1)(2, "div", 2);
            i0.ɵɵtemplate(3, AdminSidebarComponent_img_3_Template, 1, 0, "img", 3);
            i0.ɵɵelementEnd();
            i0.ɵɵelementStart(4, "button", 4);
            i0.ɵɵlistener("click", function AdminSidebarComponent_Template_button_click_4_listener() { return ctx.toggleSidebar(); });
            i0.ɵɵelement(5, "i", 5);
            i0.ɵɵelementEnd()();
            i0.ɵɵelementStart(6, "nav", 6)(7, "ul", 7);
            i0.ɵɵtemplate(8, AdminSidebarComponent_li_8_Template, 6, 8, "li", 8);
            i0.ɵɵelementEnd()();
            i0.ɵɵelementStart(9, "div", 9);
            i0.ɵɵtemplate(10, AdminSidebarComponent_div_10_Template, 8, 5, "div", 10)(11, AdminSidebarComponent_div_11_Template, 2, 2, "div", 11);
            i0.ɵɵelementStart(12, "button", 12);
            i0.ɵɵlistener("click", function AdminSidebarComponent_Template_button_click_12_listener() { return ctx.logout(); });
            i0.ɵɵnamespaceSVG();
            i0.ɵɵelementStart(13, "svg", 13);
            i0.ɵɵelement(14, "path", 14);
            i0.ɵɵelementEnd();
            i0.ɵɵtemplate(15, AdminSidebarComponent_span_15_Template, 2, 0, "span", 15);
            i0.ɵɵelementEnd()()();
        } if (rf & 2) {
