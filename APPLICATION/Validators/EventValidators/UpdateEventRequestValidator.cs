...
/// <summary>
/// FluentValidation validator for UpdateEventRequest DTO.
/// Enforces all event validation rules for updates.
/// Note: Only events in Draft status can be updated (enforced in handler).
/// </summary>
