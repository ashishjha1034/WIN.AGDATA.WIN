...
public class ApproveRedemptionHandler : IRequestHandler<ApproveRedemptionCommand, RedemptionDto>
{
    private readonly IRedemptionRepository _redemptionRepo;
    private readonly IUnitOfWork _uow;

    public ApproveRedemptionHandler(IRedemptionRepository redemptionRepo, IUnitOfWork uow)
    {
        _redemptionRepo = redemptionRepo;
        _uow = uow;
    }

    public async Task<RedemptionDto> Handle(ApproveRedemptionCommand request, CancellationToken cancellationToken)
    {
