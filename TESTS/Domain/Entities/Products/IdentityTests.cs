...
namespace IdentityTests.Domain.Entities.Products
{
    public class IdentityTests
    {
        ...
        public void Constructor_WithValidInputs_ShouldCreateProductIdentity()
        {
            ...
            // Act
            var identity = new WIN.AGDATA.WIN.Domain.Entities.Products.ProductIdentity(name, description);
        ...
        {
            // Act & Assert
            var action = () => new WIN.AGDATA.WIN.Domain.Entities.Products.ProductIdentity(name, "Valid description here");
        ...
        {
            // Act & Assert
            var action = () => new WIN.AGDATA.WIN.Domain.Entities.Products.ProductIdentity("Valid Name", description);
            action.Should().Throw<DomainException>();
        }
        ...
        {
            // Arrange
            var identity = new WIN.AGDATA.WIN.Domain.Entities.Products.ProductIdentity("Old Name", "Description here");
        ...
        {
            // Arrange
            var identity = new WIN.AGDATA.WIN.Domain.Entities.Products.ProductIdentity("Gaming Mouse", "Old description");
        ...
        {
            // Arrange
            var identity1 = new WIN.AGDATA.WIN.Domain.Entities.Products.ProductIdentity("Gaming Mouse", "Description 1");
            var identity2 = new WIN.AGDATA.WIN.Domain.Entities.Products.ProductIdentity("Gaming Mouse", "Description 2");
