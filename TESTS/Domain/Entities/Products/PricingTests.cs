...
namespace IdentityTests.Domain.Entities.Products
{
    public class PricingTests
    {
        ...
        {
            // Arrange & Act
            var pricing = new ProductPricing(500);
        ...
        {
            // Act & Assert
            var action = () => new ProductPricing(points);
        ...
        {
            // Act & Assert
            var action = () => new ProductPricing(200000);
        ...
        {
            // Arrange
            var pricing = new ProductPricing(requiredPoints);
