...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "AGDATA WIN API", Version = "v1" });
...
builder.Services.AddScoped<WIN.AGDATA.WIN.APPLICATION.Interfaces.IJwtTokenService, JwtTokenService>();
